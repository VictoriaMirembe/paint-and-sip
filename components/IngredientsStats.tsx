  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card key={ingredient.id}>
          ...
          <CardContent>
            ...
            <div className="text-lg font-bold">
              Price: ugx {ingredient.price.toFixed(2)}
            </div>
          </CardContent>
        </Card>
      ))}
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">ugx {totalPrice.toFixed(2)}</div>
      ...
      {trendingIngredient && (
        <Card>
          ...
          <CardContent>
            ...
            <div className="text-lg font-bold">
              Qty: {trendingIngredient.qty}
            </div>
            <div className="text-lg font-bold">
              Price: ugx {trendingIngredient.price.toFixed(2)}
            </div>
          </CardContent>
        </Card>
      )}
