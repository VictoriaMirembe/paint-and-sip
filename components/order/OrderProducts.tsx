  ...
  return (
    <div className="grid lg:grid-cols-4 md:grid-cols-4 grid-cols-2 gap-4 mt-8">
      {dishes.map((dish: any) => (
        <Card
          key={dish.id}
          className="w-full border-[1px] dark:border-gray-700"
        >
          ...
          <div className="grid gap-1 p-2">
            <p className="text-xs font-medium dark:text-gray-300 text-gray-500">
              {dish.subtitle}
            </p>
            ...
            <div className="flex flex-row-reverse justify-between items-center gap-2 mt-2">
              ...
              <div>
                <h2 className="font-bold dark:text-white text-gray-900 text-sm dm">
                  ugx {dish.amount}
                </h2>
              </div>
            </div>
