...
interface Dish {
  id: string;
  title: string;
  subtitle: string; // Ensure this field is included in the data
  amount: number;
  qty: number;
      ...
      <div className="lg:w-[30%] md:w-[35%] w-full md:min-h-screen lg:min-h-screen relative p-4">
        <div>
          <Card className="border-none p-0 shadow-none flex justify-between items-center">
            <CardTitle className="text-xl font-semibold tracking-wide mt-4">
              Dishes Category
            </CardTitle>
          ...
          <div className="mt-4 gap-3 grid lg:grid-cols-1 md:grid-cols-1 grid-cols-2">
            {categories?.map((cat) => {
              ...
              return (
                <div
                  key={cat.id}
                  className="max-w-xs bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 cursor-pointer"
                  role="alert"
                >
